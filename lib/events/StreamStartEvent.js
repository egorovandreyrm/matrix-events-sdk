...
var StreamStartEvent = /*#__PURE__*/function (_ExtensibleEvent) {
  ...
  function StreamStartEvent(wireFormat) {
    ...
    _defineProperty(_assertThisInitialized(_this), "stream_url", void 0);
    ...
    if (!(stream !== null && stream !== void 0 && stream.stream_url)) {
    ...
    _this.stream_url = new _MessageEvent.MessageEvent({
      type: "org.matrix.sdk.stream.stream_url",
      content: stream.stream_url
    });
  ...
  _createClass(StreamStartEvent, [{
    ...
    value: function serialize() {
      ...
      return {
        ...
        }), _defineProperty(_content, _message_types.M_TEXT.name, "".concat(this.description.text, " ").concat(this.stream_url.text, " third_party: ").concat(this.third_party)), _content)
      };
    }
  }], [{
    key: "from",
    value: function from(description, stream_url, third_party) {
      var _content2;
      ...
      return new StreamStartEvent({
        ...
        content: (_content2 = {}, _defineProperty(_content2, _message_types.M_TEXT.name, description), _defineProperty(_content2, _stream_types.M_STREAM_START.name, {
          ...
          stream_url: _defineProperty({}, _message_types.M_TEXT.name, stream_url),
